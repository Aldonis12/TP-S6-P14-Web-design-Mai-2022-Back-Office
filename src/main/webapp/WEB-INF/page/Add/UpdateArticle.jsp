...
<head>
    ...
    <meta name="description" content="Modifier - Informations sur l’intelligence artificielle">
    <title>Modifier - Informations sur l’intelligence artificielle</title>
    ...
    <main role="main" class="main-content">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h2 class="page-title">Modification</h2>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <form action="<%=request.getContextPath()%>/ModifierArticle" method="post">
                                        <input type="hidden" name="id" value="<%=list.get(0).getIdArticle()%>">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Titre</label>
                                                <input type="text" name="titre" class="form-control" value="<%=list.get(0).getTitre()%>" required>
                                            </div>
                                            <br>
                                            <div class="form-group col-md-6">
                                                <label>Date de publication</label>
                                                <input type="datetime-local" name="daty" class="form-control" value="<%=list.get(0).getDatepublication()%>" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Contenu</label>
                                                <textarea name="contenu"><%=list.get(0).getContenu()%></textarea>
                                            </div>
                                        </div>
